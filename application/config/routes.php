...
$route['(:any)/account-types'] = 'website/account_types';
$route['(:any)/instruments-list'] = 'website/instruments_list';
$route['(:any)/analytics'] = 'website/analytics';
$route['(:any)/conversion-rate'] = 'website/conversion_rate';
$route['(:any)/analytics'] = 'website/analytics';
$route['(:any)/webinars'] = 'website/webinars';
$route['(:any)/seminars'] = 'website/seminars';
$route['(:any)/economic-calender'] = 'website/economic_calender';
$route['(:any)/calculator'] = 'website/calculator';
$route['(:any)/blog'] = 'website/blog';
