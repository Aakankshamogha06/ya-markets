    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="title mb-0 wow fadeInUp" data-wow-delay="200ms"><span class="text-gradient"><?=lang('section_calculator_title')?></span></h2>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 col-xl-8 mx-auto">
                <iframe class="rounded" src="https://widgets.fxwidgets.com/calculators/default/stop-loss-take-profit.html" style="height: 534px;" frameborder="0" width="100%"></iframe>
            </div>
        </div>
    </div>
</section>
