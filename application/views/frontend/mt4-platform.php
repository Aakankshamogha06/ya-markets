    ...
    <div class="container">
        <div class="row gy-5">
            <div class="col-lg-7 col-xl-6 mx-auto text-center">
                <h5 class="text-primary fw-bold text-uppercase wow fadeInUp">MT4 PLATFORMS</h5>
                <h2 class="title mb-3 wow fadeInUp" data-wow-delay="200ms">
                    <span class="d-lg-block">Trade on World Class </span>
                    <span class="text-gradient">MT4 platforms</span>
                </h2>
                ...
                <div class="group-btn text-center mt-5">
                    <a href="./mt5-platform" class="btn btn-primary wow fadeInUp" id="platformView" data-wow-delay="100ms">View MT5 platform</a>
        ...
        <div class="row gy-4">
            <div class="col-lg-6 text-center text-lg-start">
                <div class="position-sticky top-25">
                    ...
                    <h2 class="title mb-3 wow fadeInUp" data-wow-delay="200ms">Advantages of YaMarkets <span class="text-gradient">MT4 Platforms</span></h2>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row gy-4">
                    ...
                    <div class="col-6 text-center">
                        <div class="p-sm-3 p-md-4 wow fadeInUpBig" data-wow-delay="100ms">
                            ...
                            <p class="my-2">An Extensive Array of Trading Tools</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                ...
                <h2 class="title mb-3 wow fadeInUp" data-wow-delay="200ms">How to Install <span class="text-gradient">MT4 Platform?</span></h2>
                <p class="mb-5 wow fadeInUpBig" data-wow-delay="300ms">The step-by-step process to quickly install the MT4 Platform on your device for seamless trading with YaMarkets.</p>
            </div>
