    ...
    <div class="container">
        <div class="contact-wrapper">
            <div class="row col-rev gy-5">
                    ...
                    <div class="linear-border">
                        <div class="contact-details">
                            ...
                            <!-- <div class="d-flex align-items-center gap-3">-->
                                ...
                                <!--</div>-->
                                <!--<div class="text">-->
                                <!--    <h6 class="text-primary fs-5">UAE address</h6>-->
                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-delay="400ms">
                    <div class="position-sticky top-25">
                        <form action="<?= base_url('website/submit_form'); ?>" method="post" class="contact-form">
                            <div class="row gy-4">
                                <div class="col-md-6">
...
<section>
    <div class="container">
        <div class="row gy-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="contact-card text-center wow fadeInUp" data-wow-delay="200ms">
                    <div class="icon">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="contact-card text-center wow fadeInUp" data-wow-delay="300ms">
                    <div class="icon">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="contact-card text-center wow fadeInUp" data-wow-delay="400ms">
                    <div class="icon">
