...
<head>
	...
	<link rel="icon" href="<?= base_url() ?>public/web/img/favicon.png" value="YaMarkets" type="image/">
	<style>
		body {
...
<div class="auth-wrapper">
	<div class="auth-content text-center">
		<img src="<?= base_url() ?>public/ya_images/logo.png" alt="" style="width:50%;" class="img-fluid mb-4">
			...
			<div class="row align-items-center ">
				<div class="col-md-12">
					...
					<div class="card-body">
						...
						<input type="text" name="captcha"  class="form-control" id="Password"  placeholder="CAPTCHA" >
